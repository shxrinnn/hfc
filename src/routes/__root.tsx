...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Holistic Fitness Club — Training Community" },
      { name: "description", content: "HFC — Holistic Fitness Club. Train. Reflect. Rise. A holistic training community with codex, progress tracking, leaderboards and mentorship." },
      { property: "og:site_name", content: "Holistic Fitness Club" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Holistic Fitness Club",
          alternateName: "HFC",
          url: "https://hfc-zenith-flow.lovable.app",
        }),
      },
      {
        type: "application/ld+json",
